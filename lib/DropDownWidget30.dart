...
class DropDown30 extends StatefulWidget {
   DropDown30(first) {
    uarr[10] = first;
  }
  @override
  State<StatefulWidget> createState() {
    if (dropdownflag == false) {
      for (int i = 0; i < Datingfrom!.length; i++) {
        String value = Datingfrom![i].toString();
        items.add(
...
class DropDownState extends State<DropDown30> {
  // var items = [
  //   '',
  //   'Αρχή',
  //   'Μέσα',
