...
class CheckBox8 extends StatefulWidget {
  const CheckBox8();

  @override
  State<StatefulWidget> createState() {
    if (dropdownflag == false) {
      CheckBox2Val = CheckB2;
...
class _MyWidgetState extends State<CheckBox8> {
  @override
        ...
        for (int i = 0; i < items.length; i++)
          Column(children: [
            ...
            Checkbox(
              ...
              value: (CheckB2[items.elementAt(i)]),
              onChanged: (bool? value) {
                setState(() {
                  CheckB2[items.elementAt(i)] = value!;
                  CheckBox2Val = CheckB2;
                });
              },
            ),
